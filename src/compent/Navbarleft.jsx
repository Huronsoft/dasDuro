     ...
     <div className="flex flex-col p-4 items-center">
       <div className="flex flex-row items-center p-2 gap-3 text-sm text-[rgb(156,159,164)] font-bold ">
         ...
         <div className="flex flex-col p-2 items-star text-sm text-zinc-400 font-bold">        
            ...
            <Link to="/Perfil" 
            className="flex flex-row gap-2 text-gray-300 hover:bg-gray-700
            ...
            >
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-6 h-6">
             <path fill-rule="evenodd" d="M9.315 7.584C12.195 3.883 16.695 1.5 21.75 1.5a.75.75 0 01.75.75c0 
            ...
            <Link to="/Config" className="flex flex-row gap-2 text-gray-300 hover:bg-gray-700 hover:text-white rounded-md
             ...
             >
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-6 h-6">
                <path fill-rule="evenodd" d="M11.078 2.25c-.917 0-1.699.663-1.85 1.567L9.05 4.889c-.02.12-.115.26-.297.348a7.493
                ...
                1.875 0 00-1.85-1.567h-1.843zM12 15.75a3.75 3.75 0 100-7.5 3.75 3.75 0 000 7.5z" clip-rule="evenodd" />
            </svg>  
            ...
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-6 h-6">
                <path fill-rule="evenodd" d="M12 2.25a.75.75 0 01.75.75v9a.75.75 0 01-1.5 0V3a.75.75 0 01.75-.75zM6.166 5.106a.75.75 0
                 010 1.06 8.25 8.25 0 1011.668 0 .75.75 0 111.06-1.06c3.808 3.807 3.808 9.98 0 13.788-3.807 3.808-9.98 3.808-13.788
                  0-3.808-3.807-3.808-9.98 0-13.788a.75.75 0 011.06 0z" clip-rule="evenodd" />
            </svg>
            <p>Salir</p> </Link>
