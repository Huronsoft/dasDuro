...
return (
  ...
  <div>
      ...
      <div className="grid place-items-center h-screen w-full bg-[rgb(34,37,42)] ">    
       ...
       <div className="flex flex-col rounded-xl border-1
        ...
        <div className="sm:mx-auto sm:w-full sm:max-w-sm">       
          ...
          <h2 className="mt-10 text-center text-2xl font-bold leading-9 tracking-tight text-[rgb(139,143,148)]">
           DURO HERRAJES
          </h2>
        </div>
        ...
        <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm text-[rgb(139,143,148)]">
          ...
          No es un miembro?{' '}
            <a href="/perf" className="font-semibold leading-6 text-indigo-600 hover:text-indigo-500">
             Registrate
            </a>
          </p>
        </div>
